    ...
    return (
      <div className="relative flex w-full max-w-[26rem] mt-4 flex-col rounded-xl bg-white text-gray-700 shadow-lg">
        <div className="relative mx-4 mt-4 overflow-hidden rounded-xl bg-blue-gray-500 text-white shadow-lg">
          <img src={imageUrl} alt="News Photos" />
        ...
        <div className="p-6">
          ...
          <div className="my-3">
            <Link to={newsUrl}  rel="noreferrer" target="_blank" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Read more
